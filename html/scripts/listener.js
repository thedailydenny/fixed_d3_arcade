...
document.addEventListener('keyup', function(e) {
    if (e.keyCode === 27 && gaming){
        fetch('https://d3-arcade/exit', {
            method: 'POST',
            headers: {
...
// Button click handler with delegation
$(document).on('click', '#off_pc', function() {
    $.post('https://d3-arcade/exit', JSON.stringify({}));
});
